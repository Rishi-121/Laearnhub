...
<head>
  <title>LearnHub - Be a Problem Solver</title>
</head>
...
<body>
  ...
  <h1 class="head text-center">Be a Problem Solver and help others</h1>

  <form class="jumbotron" method="POST" action="./php/connectdb-answer-keeper.php" onsubmit="return validation()">
    ...
    <div class="form-group">
      ...
      if ($con == false) {
        ...
        if ($_SESSION["id"]) {
          ...
          $id = $_SESSION['id'];
          $select = "SELECT `question` FROM `community` WHERE `id`='$id'";
          $query = mysqli_query($con, $select);
          $data = mysqli_fetch_assoc($query);

          $_SESSION['question'] = $data['question'];

          echo "<p class='form-text'>&nbsp;&nbsp;&nbsp;&nbsp;" . $data["question"] . "</p>";
        }
      }
    ...
    <div class="form-group">
      ...
      <textarea type="email" class="form-control" rows="10" cols="30" id="exampleInputanswer1" aria-describedby="emailHelp" name="answer"></textarea>
    </div>
  ...
  <script src="./javascript/answer-keeper-form-validation.js"></script>
